...
# 指示
1. まず、総合診断タイプと総合スコアについて、その意味合いを詳しく解説してください。総合診断結果の解説は2000字以上で記述し、以下の内容を含めてください：
   - 診断タイプの詳細な説明とその意味
   - 総合スコアの解釈と現在の状況
   - デジタル化推進における課題の全体像
   - 改善の方向性と期待される効果
...
2. 次に、すべてのカテゴリについて、回答順序で詳細に分析してください：
   ...
   - そのカテゴリで起きている可能性が高い具体的な問題点を3個以上
   - 各問題点について、なぜそれが問題なのかの理由
   - 改善のための具体的で実践的なアドバイスを3個以上
...
4. 各カテゴリは以下の形式で出力してください：
   ...
   * **問題点4**: 具体的な問題の説明と、なぜそれが問題なのかの理由（必要に応じて）
   
   ### 改善のための具体的アドバイス
   * **アドバイス1**: 具体的な改善方法と期待される効果
   * **アドバイス2**: 具体的な改善方法と期待される効果
   * **アドバイス3**: 具体的な改善方法と期待される効果
   * **アドバイス4**: 具体的な改善方法と期待される効果（必要に応じて）

5. 全体を通して、専門用語は避け、中小企業の経営者に寄り添うような、丁寧かつ力強いトーンで記述してください。

6. 出力はMarkdown形式で、見出しや箇条書きを効果的に使用してください。文字数は3000〜4000字程度にまとめてください。
...
${getDetailedOverallAnalysis(totalScore, resultType)}
...
/**
 * 総合診断結果の詳細分析を取得（2000文字程度）
 */
function getDetailedOverallAnalysis(totalScore, resultType) {
  if (totalScore >= 15) {
    return `【緊急対応が必要な状況について】

あなたの会社は現在、デジタル化において最も深刻な状況にあります。総合スコア${totalScore}/20点という結果は、4つの重要な領域すべてで根本的な見直しが必要であることを示しています。

この状況を放置すると、以下の深刻なリスクが発生する可能性があります：

**競争力の大幅な低下**
- アナログ業務に依存することで、競合他社との差が拡大
- 顧客サービスの質の低下により、市場シェアの減少
- 優秀な人材の流出リスクの増大
...
1. **最優先（1-3ヶ月以内）**: セキュリティ対策の強化
   - 基本的なセキュリティツールの導入
   - 従業員教育の実施
   - データバックアップ体制の確立

2. **高優先（3-6ヶ月以内）**: 業務プロセスのデジタル化
   - 主要業務の標準化と効率化
   - デジタルツールの段階的導入
   - 従業員のスキルアップ支援

3. **中優先（6-12ヶ月以内）**: データ活用基盤の構築
   - BIツールの導入
   - KPI管理システムの構築
   - データドリブン経営の文化醸成
...
同規模の企業で同様の状況から脱却した事例では、以下のアプローチが効果的でした：
- 段階的な改善計画の策定
- 外部専門家の積極的な活用
- 従業員の巻き込みと教育
- 継続的なモニタリングと改善
...
1年後には「デジタル化優等生」レベル（スコア5点以下）を目指し、3年後には「DX推進リーダー」レベル（スコア2点以下）を目標とすることが重要です。これにより、持続的な競争優位性を確保できます。`;
  } else if (totalScore >= 10) {
    return `【改善が必要な状況について】

あなたの会社は現在、デジタル化において改善が必要な状況にあります。総合スコア${totalScore}/20点という結果は、複数の領域で課題が存在し、段階的な改善が重要であることを示しています。
...
1年後には「デジタル化優等生」レベル（スコア5点以下）を目指し、さらなる競争優位性の確保を図ることが重要です。`;
  } else if (totalScore >= 5) {
    return `【部分的改善が必要な状況について】

あなたの会社は現在、デジタル化において部分的に改善が必要な状況にあります。総合スコア${totalScore}/20点という結果は、基本的なデジタル化は進んでいるものの、さらなる効率化と高度化の余地があることを示しています。
...
1年後には「DX推進リーダー」レベル（スコア2点以下）を目指し、業界におけるデジタル化の先駆者となることが重要です。`;
  } else {
    return `【優秀な状況について】

あなたの会社は現在、デジタル化において非常に優秀な状況にあります。総合スコア${totalScore}/20点という結果は、4つの重要な領域すべてで適切なデジタル化が実施されており、業界の模範となるレベルであることを示しています。
...
業界におけるデジタル化のリーダーとして、他社の模範となる存在を目指し、持続的な競争優位性を確保することが重要です。`;
  }
}
    ...
    'セキュリティ・情報管理': {
      ...
      1: {
        ...
        problems: [
          ...
          { title: '高度な対策の検討', description: '基本的な対策は十分ですが、より高度なセキュリティ対策の導入により、さらなる安全性の向上が期待できます。' },
          { title: '従業員教育の継続', description: '現在のセキュリティ意識を維持し、新たな脅威に対する知識を継続的に更新する必要があります。' }
        ],
        advice: [
          { title: '継続的なセキュリティ強化', description: '最新のセキュリティ脅威に対応するため、定期的な対策の見直しと強化を継続してください。' },
          { title: '高度なセキュリティ対策の検討', description: '多要素認証、暗号化、侵入検知システムなど、より高度なセキュリティ対策の導入を検討してください。' },
          { title: 'セキュリティ文化の醸成', description: '全社的なセキュリティ文化を醸成し、従業員一人ひとりがセキュリティの重要性を理解する環境を構築してください。' }
        ]
      },
      0: {
        ...
        problems: [
          ...
          { title: '新たな脅威への対応', description: '現在の対策は優秀ですが、新たに出現する脅威に対して継続的な対応が必要です。' },
          { title: '業界リーダーシップの確立', description: '優れたセキュリティ体制を活かし、業界におけるリーダーシップを確立する機会があります。' }
        ],
        advice: [
          { title: 'ベストプラクティスの共有', description: '他の部門や他社との情報交換により、さらなる改善の機会を探してください。' },
          { title: '業界標準の策定', description: '優れたセキュリティ体制を活かし、業界標準の策定に貢献してください。' },
          { title: '継続的イノベーション', description: '最新のセキュリティ技術を積極的に取り入れ、継続的なイノベーションを推進してください。' }
        ]
      }
    },
    '経営・データ活用': {
      5: {
        ...
        advice: [
          ...
          { title: 'データ収集プロセスの標準化', description: 'データの収集方法を標準化し、品質の高いデータを継続的に取得できる体制を構築してください。' },
          { title: '経営会議でのデータ活用', description: '定期的な経営会議でデータに基づく意思決定を習慣化し、データドリブンな経営文化を醸成してください。' }
        ]
      },
      4: {
      ...
      1: {
        ...
        problems: [
          ...
          { title: '高度な分析手法の検討', description: '基本的なデータ活用は十分ですが、より高度な分析手法の導入により、さらなる経営効率化が期待できます。' },
          { title: '予測分析の導入', description: '現在の分析手法に加えて、予測分析や機械学習を活用した高度な分析の導入を検討してください。' }
        ],
        advice: [
          { title: '継続的なデータ活用強化', description: '最新のデータ分析手法を継続的に学習し、経営判断の精度向上を図ってください。' },
          { title: '高度な分析手法の導入', description: '統計分析や機械学習を活用した、より高度なデータ分析手法の導入を検討してください。' },
          { title: 'データドリブン文化の醸成', description: '全社的なデータドリブン文化を醸成し、データに基づく意思決定を習慣化してください。' }
        ]
      },
      0: {
        ...
        problems: [
          ...
          { title: '業界リーダーシップの確立', description: '優れたデータ活用体制を活かし、業界におけるリーダーシップを確立する機会があります。' },
          { title: '新たな価値創造', description: '現在のデータ活用を基盤として、新たなビジネス価値の創造に挑戦してください。' }
        ],
        advice: [
          { title: 'ベストプラクティスの共有', description: '他の企業との情報交換により、さらなる改善の機会を探してください。' },
          { title: '業界標準の策定', description: '優れたデータ活用体制を活かし、業界標準の策定に貢献してください。' },
          { title: '継続的イノベーション', description: '最新のデータ分析技術を積極的に取り入れ、継続的なイノベーションを推進してください。' }
        ]
      }
    },
    '業務プロセス・効率化': {
      5: {
        ...
        advice: [
          ...
          { title: '従業員教育の実施', description: '新しいツールやプロセスの使い方を従業員に教育し、定着を図ってください。' },
          { title: '定期的なプロセス監査', description: '業務プロセスの効果を定期的に評価し、継続的な改善を実施してください。' }
        ]
      },
      4: {
      ...
      1: {
        ...
        problems: [
          ...
          { title: '高度な効率化手法の検討', description: '基本的な効率化は十分ですが、より高度な手法の導入により、さらなる生産性向上が期待できます。' },
          { title: 'AI・RPAの活用', description: '現在の効率化に加えて、AIやRPAを活用した高度な自動化の導入を検討してください。' }
        ],
        advice: [
          { title: '継続的な効率化', description: '最新の効率化手法を継続的に学習し、さらなる改善を図ってください。' },
          { title: '高度な効率化手法の導入', description: 'AIや機械学習を活用した、より高度な業務効率化手法の導入を検討してください。' },
          { title: '効率化文化の醸成', description: '全社的な効率化文化を醸成し、継続的な改善を習慣化してください。' }
        ]
      },
      0: {
        ...
        problems: [
          ...
          { title: '業界リーダーシップの確立', description: '優れた効率化体制を活かし、業界におけるリーダーシップを確立する機会があります。' },
          { title: '新たな価値創造', description: '現在の効率化を基盤として、新たなビジネス価値の創造に挑戦してください。' }
        ],
        advice: [
          { title: 'ベストプラクティスの共有', description: '他の企業との情報交換により、さらなる改善の機会を探してください。' },
          { title: '業界標準の策定', description: '優れた効率化体制を活かし、業界標準の策定に貢献してください。' },
          { title: '継続的イノベーション', description: '最新の効率化技術を積極的に取り入れ、継続的なイノベーションを推進してください。' }
        ]
      }
    },
    'コミュニケーション・情報共有': {
      5: {
        ...
        advice: [
          ...
          { title: '定期的なコミュニケーション改善', description: 'コミュニケーション手法を定期的に見直し、継続的な改善を実施してください。' }
        ]
      },
      4: {
      ...
      1: {
        ...
        problems: [
          ...
          { title: '高度なコミュニケーション手法の検討', description: '基本的なコミュニケーションは十分ですが、より高度な手法の導入により、さらなる効率化が期待できます。' },
          { title: 'デジタル変革の推進', description: '現在のコミュニケーションに加えて、デジタル変革を推進する高度な手法の導入を検討してください。' }
        ],
        advice: [
          { title: '継続的なコミュニケーション改善', description: '最新のコミュニケーション手法を継続的に学習し、さらなる改善を図ってください。' },
          { title: '高度なコミュニケーション手法の導入', description: 'ビデオ会議、チャット、プロジェクト管理ツールなどを活用した、より高度なコミュニケーション手法の導入を検討してください。' },
          { title: 'コミュニケーション文化の醸成', description: '全社的なコミュニケーション文化を醸成し、情報共有を習慣化してください。' }
        ]
      },
      0: {
        ...
        problems: [
          ...
          { title: '業界リーダーシップの確立', description: '優れたコミュニケーション体制を活かし、業界におけるリーダーシップを確立する機会があります。' },
          { title: '新たな価値創造', description: '現在のコミュニケーションを基盤として、新たなビジネス価値の創造に挑戦してください。' }
        ],
        advice: [
          { title: 'ベストプラクティスの共有', description: '他の企業との情報交換により、さらなる改善の機会を探してください。' },
          { title: '業界標準の策定', description: '優れたコミュニケーション体制を活かし、業界標準の策定に貢献してください。' },
          { title: '継続的イノベーション', description: '最新のコミュニケーション技術を積極的に取り入れ、継続的なイノベーションを推進してください。' }
        ]
      }
    }
  };
